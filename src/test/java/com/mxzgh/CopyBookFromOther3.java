 ...
 */
public class CopyBookFromOther3 {

    static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(CopyBookFromOther3.class);

    static CloseableHttpClient client ;
    static Pattern p = Pattern.compile("https://www.lightnovel.cn/thread-[0-9]+-1-1.html");
    ...
    public static void main(String[] args) {
        String uri = "https://www.lightnovel.cn/thread-85476-1-1.html";
        printUrl(uri);
//        for(int i = 31;i<32;i++){
//                try {
